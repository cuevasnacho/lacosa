...
aterrador_Effect = "Sólo puedes jugar esta carta como respuesta a un ofrecimiento de intercambio de cartas. Niégate a un intercambio de cartas solicitado por un jugador o por el efecto de una carta. Mira la carta que te has negado a coger y devuélvesela a su dueño"

class Aterrador(card_template):
    def __init__(self):
        super().__init__(False, cards_subtypes.DEFENSE.value, aterrador_Effect, "aterrador")

    def valid_play(self, player_cause_id, tarjet_id):
        return True
    ...
    def aplay_defense_effect(self, defensor_id, attacker_id):
        ...
        defensor.player_exchangeL = False
        defensor.player_exchangeR = False
